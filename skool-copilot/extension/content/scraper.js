...
(function () {
  ...
  /* ---------------------- page-pulse source ------------------------ */
  // Backend-free: the side panel's "Page pulse" asks what's on the current
  // Skool page (via the class-free SC.extract) to analyze engagement and
  // pillar coverage. Gated by the live admin signal OR the per-community
